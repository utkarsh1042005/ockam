...
use ockam::identity::{SecureChannelListenerOptions, TrustContext, Vault};
...
async fn main(ctx: Context) -> Result<()> {
    ...
    let trust_context = TrustContext::new("trust_context_id".to_string(), issuer.identifier().clone());
